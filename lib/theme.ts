...
export const ACCENT = '#6366f1'           // indigo — swap to e.g. '#4ade80' for green

// Derived from ACCENT — adjust opacity as needed
export const ACCENT_DIM    = 'rgba(99,102,241,0.12)'
export const ACCENT_BORDER = 'rgba(99,102,241,0.30)'
export const ACCENT_GLOW   = 'rgba(99,102,241,0.20)'
// Text color on dark background using accent tone
export const ACCENT_LIGHT  = '#a5b4fc'
